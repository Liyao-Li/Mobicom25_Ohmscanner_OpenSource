...
if __name__ == "__main__":
    ...
    if mode == 1:##keystub_distance
        ...
        fig, ax = plt.subplots(figsize=(7.2, 5.5), sharex=True)  # 修改为1x4的布局
        wide = 0.5
        lindw = 2
        ...
        plt.subplots_adjust(left=0.132, right=0.996, top=0.99,
        ...
        fig, ax = plt.subplots(figsize=(6.3, 5.5), sharex=True)  # 修改为1x4的布局
        wide = 0.5
        lindw = 2
        positions = np.arange(1, 12 + 1, 1)
        # 使用箱线图代替小提琴图
        ...
        fig, ax = plt.subplots(figsize=(6.2, 5.5), sharex=True)  # 修改为1x4的布局
        wide = 0.5
        lindw = 2
        positions = np.arange(1, 12 + 1, 1)
        # 使用箱线图代替小提琴图
