...
if __name__ == "__main__":
    ...
    if mode == 1:
        ...
        legend_properties = FontProperties(family='Times New Roman', weight='normal', size=26)
        plt.legend(prop=legend_properties, frameon=False, handlelength=0.7, ncol=1, loc=(0, 0.6),
        ...
        legend_properties = FontProperties(family='Times New Roman', weight='normal', size=26)
        plt.legend(prop=legend_properties, frameon=False, handlelength=0.7, ncol=1, loc=(0, 0.58),
