...
if __name__ == "__main__":
    ...
    if mode == 1:
        ...
        ax2.bar(index + bar_width, data5, bar_width, label='OhmScanner', hatch='\\', color=colors[1], edgecolor=edge_color,alpha=alp)
        print(index)
        ...
        ax1.bar(index + 2 * bar_width, data3, bar_width, label='OhmScanner', hatch='\\', color=colors[1], edgecolor=edge_color,alpha=alp)
